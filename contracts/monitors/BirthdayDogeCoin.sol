...
contract BirthdayDogeCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0xBaEd18AF4bAcA7b42975aB7d73B18c9FD30c2C66); // Marketing Address

    address payable public liquidityAddress =
    payable(0xa50Db7e8968A50f992581e9591d197599507D111); // Liquidity Address
    ...
    constructor() {
        address newOwner = address(0xa50Db7e8968A50f992581e9591d197599507D111);
